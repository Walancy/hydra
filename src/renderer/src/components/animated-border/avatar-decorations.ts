...
export const DECORATION_CATEGORIES = Object.keys(CATEGORY_LABELS) as DecorationCategory[];
...
export const AVATAR_DECORATIONS: AvatarDecoration[] = [
  ...
  { id: "fresh_pine_cinnamon", label: "Fresh Pine (Cinnamon)", category: "seasonal" },
  { id: "fresh_pine_ribbon", label: "Fresh Pine (Ribbon)", category: "seasonal" },
  { id: "spooky_cat_ears", label: "Spooky Cat Ears", category: "seasonal" },
  { id: "spooky_cat_ears_midnight", label: "Spooky Cat Ears (Midnight)", category: "seasonal" },
  { id: "candlelight", label: "Candlelight", category: "seasonal" },
  { id: "candlelight_crimson", label: "Candlelight (Crimson)", category: "seasonal" },
  ...
  { id: "witch_hat_midnight", label: "Witch Hat (Midnight)", category: "seasonal" },
  { id: "zombie_food", label: "Zombie Food", category: "seasonal" },
  { id: "zombie_food_purple", label: "Zombie Food (Purple)", category: "seasonal" },
  { id: "bloodthirsty", label: "Bloodthirsty", category: "seasonal" },
  { id: "bloodthirsty_green", label: "Bloodthirsty (Green)", category: "seasonal" },
  { id: "bloodthirsty_gold", label: "Bloodthirsty (Gold)", category: "seasonal" },
  ...
  { id: "string_lights_aurora", label: "String Lights (Aurora)", category: "seasonal" },
  { id: "string_lights_ember", label: "String Lights (Ember)", category: "seasonal" },
  { id: "string_lights_dusk", label: "String Lights (Dusk)", category: "seasonal" },
  { id: "string_lights_mix", label: "String Lights (Mix)", category: "seasonal" },
  { id: "chrysanthemums_twilight", label: "Chrysanthemums (Twilight)", category: "seasonal" },
  { id: "chrysanthemums_morning", label: "Chrysanthemums (Morning)", category: "seasonal" },
  { id: "dusk_and_dawn", label: "Dusk and Dawn", category: "seasonal" },
  { id: "floral_harmony", label: "Floral Harmony", category: "seasonal" },
  { id: "floral_harmony_sunburst", label: "Floral Harmony (Sunburst)", category: "seasonal" },
  { id: "autumns_arbor", label: "Autumn's Arbor", category: "seasonal" },
  { id: "autumns_arbor_aurora", label: "Autumn's Arbor (Aurora)", category: "seasonal" },
  ...
  { id: "fortnite_galactic_battle", label: "Galactic Battle", category: "gaming" },
  { id: "fortnite_boogie_bomb", label: "Boogie Bomb", category: "gaming" },
  { id: "street_fighter_6_battle_field", label: "SF6 Battle Field", category: "gaming" },
  ...
  { id: "valorant_champions_2024", label: "Valorant Champions 2024", category: "gaming" },
  { id: "yoru_dimensional_drift", label: "Yoru Dimensional Drift", category: "gaming" },
  { id: "viper_poison_cloud", label: "Viper Poison Cloud", category: "gaming" },
  { id: "cypher_neural_theft", label: "Cypher Neural Theft", category: "gaming" },
  ...
  { id: "ramen_bowl_toppings", label: "Ramen Bowl Toppings", category: "anime" },
  ...
  // ── Fantasy & Magic ──────────────────────────────────────────────────────
  { id: "spirit_blossom_springs_sett", label: "Spirit Blossom (Sett)", category: "fantasy" },
  { id: "spirit_blossom_springs", label: "Spirit Blossom Springs", category: "fantasy" },
  { id: "spirit_blossom_springs_ahri", label: "Spirit Blossom (Ahri)", category: "fantasy" },
  ...
  { id: "gelatinous_cube_green", label: "Gelatinous Cube (Green)", category: "fantasy" },
  { id: "gelatinous_cube_blue", label: "Gelatinous Cube (Blue)", category: "fantasy" },
  { id: "owlbear_cub", label: "Owlbear Cub", category: "fantasy" },
  { id: "owlbear_cub_snowy", label: "Owlbear Cub (Snowy)", category: "fantasy" },
  { id: "baby_displacer_beast", label: "Baby Displacer Beast", category: "fantasy" },
  { id: "magic_mists", label: "Magic Mists", category: "fantasy" },
  { id: "spirit_blossom_zed", label: "Spirit Blossom (Zed)", category: "fantasy" },
  { id: "spirit_blossom_morgana", label: "Spirit Blossom (Morgana)", category: "fantasy" },
  { id: "spirit_blossom_karma", label: "Spirit Blossom (Karma)", category: "fantasy" },
  ...
  { id: "neon_cat_hoodie_blue", label: "Neon Cat Hoodie (Blue)", category: "aesthetic" },
  { id: "neon_cat_hoodie_pink", label: "Neon Cat Hoodie (Pink)", category: "aesthetic" },
  { id: "neon_cat_hoodie_black", label: "Neon Cat Hoodie (Black)", category: "aesthetic" },
  { id: "heartbloom", label: "Heartbloom", category: "aesthetic" },
  { id: "rose_bearer_pink", label: "Rose Bearer (Pink)", category: "aesthetic" },
  ...
  { id: "mirage_nightshade", label: "Mirage (Nightshade)", category: "aesthetic" },
  ...
  { id: "valorant_summer_kickoff", label: "VALORANT Summer Kickoff", category: "quests" },
  { id: "i_love_repo", label: "I Love R.E.P.O.", category: "quests" },
  { id: "freezer_bunny_lovebug", label: "Freezer Bunny Lovebug", category: "quests" },
  { id: "lego_fortnite", label: "LEGO® Fortnite", category: "quests" },
  { id: "fortnite_galactic_battle", label: "Fortnite Galactic Battle", category: "quests" },
  { id: "fortnite_boogie_bomb", label: "Fortnite Boogie Bomb", category: "quests" },
  { id: "street_fighter_6_battle_field", label: "Street Fighter 6 Battle Field", category: "quests" },
  ...
  { id: "how_to_train_your_dragon", label: "How to Train Your Dragon", category: "quests" },
  ...
  { id: "wallach_spaceport", label: "Wallach IX Spaceport", category: "quests" },
  { id: "champions_tactibear", label: "Champions Tactibear", category: "quests" },
  ...
  { id: "jeff_the_land_shark", label: "Jeff the Land Shark", category: "quests" },
  ...
  { id: "lights_camera_action_teal", label: "Lights, Camera, Action! (Teal)", category: "quests" },
  ...
  { id: "lights_camera_action_orange", label: "Lights, Camera, Action! (Orange)", category: "quests" },
  ...
  { id: "the_conjuring_last_rites", label: "The Conjuring: Last Rites", category: "quests" },
  { id: "eye_of_prophesy", label: "Eye of Prophesy", category: "quests" },
  { id: "espn", label: "ESPN", category: "quests" },
  { id: "wendys_x_wednesday", label: "Wendy’s x Wednesday", category: "quests" },
  ...
  { id: "call_of_duty_mobile", label: "Call of Duty: Mobile", category: "quests" },
  ...
  { id: "jurassic_world_rebirth", label: "Jurassic World Rebirth Trailer", category: "quests" },
  { id: "mission_impossible", label: "Mission: Impossible", category: "quests" },
  ...
  { id: "signal_from_tau_ceti", label: "Signal from Tau Ceti", category: "quests" },
  ...
  { id: "starlight_tiara", label: "Starlight Tiara", category: "lunar_eclipse" },
  ...
  { id: "neon_cat_hoodie_blue", label: "Neon Cat Hoodie (Blue)", category: "rawr_xd" },
  { id: "neon_cat_hoodie_pink", label: "Neon Cat Hoodie (Pink)", category: "rawr_xd" },
  { id: "neon_cat_hoodie_black", label: "Neon Cat Hoodie (Black)", category: "rawr_xd" },
  { id: "mischievous_kitties_hearts", label: "Mischievous Kitties (Hearts)", category: "rawr_xd" },
  { id: "neon_decora_hair", label: "Neon Decora Hair", category: "rawr_xd" },
  { id: "neon_spike_choker", label: "Neon Spike Choker", category: "rawr_xd" },
  { id: "neon_spike_choker_black", label: "Neon Spike Choker (Black)", category: "rawr_xd" },
  { id: "mischievous_kitties", label: "Mischievous Kitties", category: "rawr_xd" },
  { id: "mischievous_kitties_blue", label: "Mischievous Kitties (Blue)", category: "rawr_xd" },
  ...
  { id: "mini_supreme_kai", label: "Mini Supreme Kai", category: "dragon_ball" },
  { id: "mini_piccolo", label: "Mini Piccolo", category: "dragon_ball" },
  { id: "panzy", label: "Panzy", category: "dragon_ball" },
  // ── SPIRIT BLOSSOM BEYOND ──────────────────────────────────────────────────
  { id: "spirit_blossom_springs_sett", label: "Spirit Blossom Springs Sett", category: "spirit_blossom" },
  { id: "spirit_blossom_springs", label: "Spirit Blossom Springs", category: "spirit_blossom" },
  { id: "spirit_blossom_springs_ahri", label: "Spirit Blossom Springs Ahri", category: "spirit_blossom" },
  { id: "spirit_blossom_zed", label: "Spirit Blossom Zed", category: "spirit_blossom" },
  { id: "spirit_blossom_morgana", label: "Spirit Blossom Morgana", category: "spirit_blossom" },
  { id: "spirit_blossom_karma", label: "Spirit Blossom Karma", category: "spirit_blossom" },
  ...
  // ── MY HERO ACADEMIA ──────────────────────────────────────────────────
  { id: "izuku_midoriya", label: "Izuku Midoriya", category: "my_hero_academia" },
  { id: "katsuki_bakugo", label: "Katsuki Bakugo", category: "my_hero_academia" },
  { id: "ochaco_uraraka", label: "Ochaco Uraraka", category: "my_hero_academia" },
  { id: "shoto_todoroki", label: "Shoto Todoroki", category: "my_hero_academia" },
  ...
  { id: "tomura_shigaraki", label: "Tomura Shigaraki", category: "my_hero_academia" },
  // ── STAR WARS™ ──────────────────────────────────────────────────
  { id: "space_battle", label: "Space Battle", category: "star_wars" },
  { id: "lightsabers_blue_and_red", label: "Lightsabers (Blue and Red)", category: "star_wars" },
  { id: "lightsabers_green_and_red", label: "Lightsabers (Green and Red)", category: "star_wars" },
  { id: "r2_d2_on_tatooine", label: "R2-D2 on Tatooine", category: "star_wars" },
  { id: "curious_bb_8", label: "Curious BB-8", category: "star_wars" },
  { id: "yoda_on_dagobah", label: "Yoda on Dagobah", category: "star_wars" },
  { id: "millennium_falcon_hyperdrive", label: "Millennium Falcon Hyperdrive", category: "star_wars" },
  // ── JENNIE ──────────────────────────────────────────────────
  { id: "ruby_hearts", label: "Ruby Hearts", category: "jennie" },
  // ── STEAMPUNK ──────────────────────────────────────────────────
  { id: "steampunk_cat_ears", label: "Steampunk Cat Ears", category: "steampunk" },
  ...
  { id: "timekeepers_clock", label: "Timekeeper's Clock", category: "steampunk" },
  ...
  { id: "magic_portal_purple", label: "Magic Portal (Purple)", category: "fantasy" },
  { id: "magic_portal_blue", label: "Magic Portal (Blue)", category: "fantasy" },
  { id: "fairy_sprites_pink", label: "Fairy Sprites (Pink)", category: "fantasy" },
  { id: "fairy_sprites_blue", label: "Fairy Sprites (Blue)", category: "fantasy" },
  { id: "fairy_sprites", label: "Fairy Sprites", category: "fantasy" },
  { id: "crystal_ball_purple", label: "Crystal Ball (Purple)", category: "fantasy" },
  { id: "crystal_ball_blue", label: "Crystal Ball (Blue)", category: "fantasy" },
  { id: "wizard_hat_purple", label: "Wizard Hat (Purple)", category: "fantasy" },
  { id: "wizard_hat_blue", label: "Wizard Hat (Blue)", category: "fantasy" },
  { id: "magical_wand_purple", label: "Magical Wand (Purple)", category: "fantasy" },
  { id: "magical_wand_green", label: "Magical Wand (Green)", category: "fantasy" },
  ...
  { id: "sleepy_chilledcow", label: "Sleepy ChilledCow", category: "lofi_girl" },
  ...
  { id: "cozy_post_it_festive", label: "Cozy Post-It (Festive)", category: "lofi_girl" },
  // ── ARCANE ──────────────────────────────────────────────────
  { id: "the_anomaly", label: "The Anomaly", category: "arcane" },
  { id: "the_mark", label: "The Mark", category: "arcane" },
  { id: "the_monster_you_created", label: "The Monster You Created", category: "arcane" },
  { id: "the_atlas_gauntlets", label: "The Atlas Gauntlets", category: "arcane" },
  ...
  { id: "midnight_sorceress", label: "Midnight Sorceress", category: "dark_fantasy" },
