...
export function IconLightPillar({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      ...
      <ellipse cx="8" cy="10" rx="3" ry="1.5" stroke="currentColor" strokeWidth="1.2" opacity="0.6" />
    </svg>
  );
}
...
export function IconFloatingLines({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <path d="M1 5c1.5-2 3-2 4.5 0s3 2 4.5 0" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" fill="none" />
      <path d="M1 8.5c1.5-2 3-2 4.5 0s3 2 4.5 0" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" fill="none" />
      <path d="M1 12c1.5-2 3-2 4.5 0s3 2 4.5 0" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" fill="none" />
    </svg>
  );
}
...
export function IconColorBends({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      ...
      <path d="M4 8c2-3 6-3 8 0" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity="0.5" />
    </svg>
  );
}
...
export function IconParticles({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      {[
        [3,3,1.5],[8,2,1],[13,4,1.2],[2,9,1],[6,7,1.8],[11,8,1],
        [4,13,1.2],[9,12,1.5],[13,11,1],[7.5,5,0.8],
      ].map(([cx,cy,r],i) => (
        <circle key={i} cx={cx} cy={cy} r={r} fill="currentColor" opacity={0.7} />
      ))}
    </svg>
  );
}
...
export function IconBeams({ size = 16, ...p }: IconProps) {
  return (
    <svg {...base(size)} {...p}>
      <path d="M2 14L6 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.5" />
      <path d="M5.5 14L8.5 2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M9 14L11 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.5" />
      <path d="M12.5 14L13.5 2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity="0.3" />
    </svg>
  );
}
  ...
  return (
    <svg {...base(size)} {...p}>
      {[
        ...
        <rect key={i} x={x} y={y} width="2.5" height="2.5" rx={0.4} fill="currentColor" opacity={i%3===0 ? 1 : 0.5} />
      ))}
    </svg>
  );
}
